...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ArticleSearchType' => function () {
    return ($this->privates['App\Form\ArticleSearchType'] ?? $this->privates['App\Form\ArticleSearchType'] = new \App\Form\ArticleSearchType());
}, 'App\\Form\\ArticleType' => function () {
